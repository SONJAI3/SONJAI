...
-- ui -- 
local ui = game:GetService("CoreGui"):FindFirstChild("SONJAI X HUB VER 0.0.1")
if ui then
   ui:Destroy()
end
-- init
...
local lib = library.new("SONJAI X HUB")
...
Pvp:addToggle("Kill Player (Gun)",false,function(bool)
   ...
   if pk == true then
   repeat wait()
      if plr2.Data.DevilFruit.value ~= "Human-Human: Buddha" then
         game.Players.LocalPlayer.Character.Humanoid:ChangeState(11)
         ...
         if plr2.Character:FindFirstChild("HumanoidRootPart") ~= nil then
               ...
               plr1.HumanoidRootPart.CFrame = plr2.Character.HumanoidRootPart.CFrame * CFrame.new(20, 85, 0)

         end
         end)
         plr2.Character.HumanoidRootPart.Size = Vector3.new(80, 80, 80)		 
         game:GetService'VirtualUser':CaptureController() -- Click
         game:GetService'VirtualUser':Button1Down(Vector2.new(1270, 371))
      end
   until pk == false
...
RSFunction:addButton("FPS Boost",function()
...
RSFunction:addToggle("No Clip 2 ",false,function(t)
   if t == true then
      _G.conn = game:GetService("RunService").Stepped:Connect(function()
      game.Players.LocalPlayer.Character.Humanoid:ChangeState(11)
      end)
...
games:addButton("Delete Ui",function()
   local ui = game:GetService("CoreGui"):FindFirstChild("SONJAI X HUB")
   if ui then
      ui:Destroy()
   end
end)
...
lib:Notify("SON JAI","Loaded")
wait(0.1)
lib:Notify("SON JAI","EDIT BY SONJAI X HUB")
